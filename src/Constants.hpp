...
class Constants {
    ...
    static constexpr int CARNIVORE_WANDER_CHANCE = 50;  
    ...
    static constexpr int CARNIVORE_MATE_RANGE = 3;  
    static constexpr int CARNIVORE_MATE_PROXIMITY = 3; 
    static constexpr int CARNIVORE_MATE_HEALTH_COST = 40;  
    static constexpr int CARNIVORE_MAX_NEARBY_TO_SEARCH_MATE = 999999;  // no limit 
    
    // Health Decay
    static constexpr int HERBIVORE_HEALTH_DECAY = 1;
    static constexpr int HERBIVORE_DECAY_CHANCE = 5;  
    static constexpr int CARNIVORE_HEALTH_DECAY = 1;
    static constexpr int CARNIVORE_DECAY_CHANCE = 5;  
    
    // Spawning
    static constexpr int HERBIVORE_SPAWN_MIN_GROUP_SIZE = 2;
    static constexpr int HERBIVORE_SPAWN_MAX_GROUP_SIZE = 5;
    static constexpr int HERBIVORE_SPAWN_CLUSTER_RADIUS = 2;  
